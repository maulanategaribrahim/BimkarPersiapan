...
class JadwalPeriksaController extends Controller
{
    ...
    {
        $jadwalPeriksas = JadwalPeriksa::where(
            'id_dokter',
            Auth::user()->id
        )->get();
...
Sabtu,Minggu',
        ...
        // Cek jika dokter sudah memiliki jadwal periksa yangsama
